...
import AMS.BaseAMS;
import AMS.Pages.AddSupplierPage;
import AMS.Pages.LoginPage;
import AMS.Pages.SupplierListPage;
import com.thedeanda.lorem.LoremIpsum;
import org.testng.annotations.Test;

import java.awt.*;

public class AddSupplierTestCases extends BaseAMS {
...
//        Assert.assertTrue(addSupplierPage1.isSuccessMsgDisplayed());
    ...
    public void addSupplierPageShouldBeDisplayed() throws InterruptedException, AWTException {
        ...
        SupplierListPage addSupplierPage1 = new LoginPage()
                .getEmail("requester@supplier.com")
                .getpassword("1234")
                .getLoginBtn()
                .expandMenu()
